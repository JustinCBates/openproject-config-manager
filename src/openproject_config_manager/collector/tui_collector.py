...
class OpenProjectConfigCollector:
    ...
    def __init__(self, flows_dir: str = None, output_dir: str = "output"):
        # Use layouts directory for flows if not specified
        if flows_dir is None:
            flows_dir = Path(__file__).parent / "layouts"
    ...
    def collect_configuration(
        ...
        try:
            ...
            flow_response = self.renderer.render_flow(
                flow_path=str(flow_path), mock_responses=mock_responses, quiet=False
            )
        ...
        config_data = {
            ...
            "database": {
                ...
                "host": (
                    ...
                    else database.get("host", "localhost")
                ),
                ...
                ),  # Use admin password as db password for container setup
            },
            # Proxy configuration
            "proxy": {
    ...
    def _generate_simple_deploy_config(self, responses: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "deployment": {
                ...
                "environment_files": ["openproject.env", "database.env"],
    ...
    def _generate_deploy_config(
        self, config: Configuration, responses: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def test_flow(self, flow_name: str, mock_responses: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            flow_path = self.flows_dir / f"{flow_name}.yml"
            flow_response = self.renderer.render_flow(
                flow_path=str(flow_path), mock_responses=mock_responses, quiet=True
            )
