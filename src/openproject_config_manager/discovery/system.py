...
class SystemDiscovery:
    ...
    def _get_hardware_info(self) -> Dict[str, Any]:
        ...
        hardware_info = {"cpu_count": os.cpu_count(), "memory": {}, "disk": {}}
    ...
    def _get_network_fallback(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            interfaces.append({"name": "primary", "addresses": {"ipv4": [{"addr": local_ip}]}})
        except Exception as e:
    ...
    def _get_storage_info(self) -> Dict[str, Any]:
        ...
        storage_info = {"filesystems": [], "mount_points": [], "disk_devices": []}
    ...
    def _generate_recommendations(self, system_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "total_gb" in memory_info:
            ...
            if total_gb < 2:
                recommendations["memory"][
                    "warning"
                ] = "Low memory detected. Consider increasing to at least 4GB for production."
                recommendations["performance"]["web_concurrency"] = 1
            elif total_gb < 4:
                recommendations["memory"][
                    "info"
                ] = "Moderate memory available. Consider 4GB+ for production workloads."
        ...
        if "free_gb" in disk_info:
            ...
            if free_gb < 10:
                recommendations["storage"][
                    "warning"
                ] = "Low disk space. Ensure at least 20GB free for production."
            elif free_gb < 50:
                recommendations["storage"][
                    "info"
                ] = "Moderate disk space. Monitor usage in production."
        ...
        if user_info.get("is_admin"):
            recommendations["security"][
                "warning"
            ] = "Running as administrator. Consider using a dedicated user for production."

        if not user_info.get("docker_access"):
            recommendations["security"][
                "info"
            ] = "Docker access not detected. Ensure Docker is installed and accessible."
