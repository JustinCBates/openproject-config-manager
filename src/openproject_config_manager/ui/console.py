...
class ConsoleUI:
    ...
    def show_title(self, title: str):
        ...
        title_panel = Panel(Align.center(title_text), border_style="bright_blue", padding=(1, 2))
        self.console.print()
    ...
    def show_phase_header(self, phase: str, description: str = ""):
        ...
        phase_panel = Panel(content, border_style="bright_green", padding=(0, 1))
        self.console.print()
    ...
    def show_table(
        self, title: str, headers: List[str], rows: List[List[str]], show_header: bool = True
    ):
        """
    ...
    def show_spinner(self, message: str):
        ...
        """
        return Progress(SpinnerColumn(), TextColumn(message), console=self.console, transient=True)
