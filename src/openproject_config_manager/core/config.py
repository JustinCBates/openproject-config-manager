...
class Configuration(BaseModel):
    ...
    # Email Configuration
    email_delivery_method: str = Field(default="smtp", choices=["smtp", "sendmail", "letter_opener"])
    ...
    def to_cfg_format(self) -> str:
        ...
        if self.smtp_address:
            ...
            lines.append(f'SMTP_ENABLE_STARTTLS_AUTO="{str(self.smtp_enable_starttls_auto).lower()}"')
        lines.append("")
    ...
    def from_cfg_file(cls, filepath: Union[str, Path]) -> 'Configuration':
        ...
        proxy_config = ProxyConfig(
            ...
            additional_domains=config_data.get('ADDITIONAL_DOMAINS', '').split(',') if config_data.get('ADDITIONAL_DOMAINS') else [],
            ...
            reverse_proxy_enabled=config_data.get('REVERSE_PROXY_ENABLED', 'true').lower() == 'true',
        )
        ...
        return cls(
            ...
            smtp_port=int(config_data.get('SMTP_PORT', 587)) if config_data.get('SMTP_PORT') else 587,
            ...
            smtp_enable_starttls_auto=config_data.get('SMTP_ENABLE_STARTTLS_AUTO', 'true').lower() == 'true',
            ...
            session_cookie_secure=config_data.get('SESSION_COOKIE_SECURE', 'true').lower() == 'true',
