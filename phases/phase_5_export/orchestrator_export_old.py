...
class ExportPhase:
    ...
    def execute(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        export_summary = {
            ...
            "files": [str(docker_compose_file), str(env_file), str(manifest_file)],
        }
    ...
    def _export_docker_compose(
        self, validated_config: Dict[str, Any], user_config: Dict[str, Any]
    ) -> Path:
        """
        ...
        docker_compose = {
            ...
            "services": {
                "openproject": {
                    ...
                    "environment": {
                        "OPENPROJECT_HOST__NAME": network.get(
                            "domain", "openproject.local"
                        ),
                        "OPENPROJECT_HTTPS": str(
                            network.get("ssl_enabled", False)
                        ).lower(),
                    ...
                    "volumes": ["openproject-data:/var/openproject/assets"],
                    "depends_on": ["db"],
            ...
            "volumes": {"openproject-data": {}, "postgres-data": {}},
            "networks": {
                "default": {
            ...
            env_vars.update(
                {
                    ...
                    "EMAIL_DELIVERY_METHOD": (
                        email.get("smtp_server", "smtp")
                        if email.get("smtp_server")
                        else "mailhog"
                    ),
...
def main():
    ...
    )  # Go up 2 levels: phase_5_export -> phases -> config-manager
