...
class DefaultsTransformer:
    ...
    def transform_enhanced_defaults(self, enhanced_defaults: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def flatten_enhanced_defaults(self, enhanced_defaults: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _load_defaults_mapping(self) -> Dict[str, Any]:
        ...
        search_paths = [
            self.project_root / "src" / "openproject_config_manager" / "core" / "defaults_map.json",
    ...
    def _apply_field_mapping(self, enhanced_defaults: Dict[str, Any], 
                           mapping_config: Dict[str, Any]) -> Dict[str, str]:
        """
    ...
    def write_tui_defaults_file(self, tui_defaults: Dict[str, Any], output_path: Path) -> str:
        """
