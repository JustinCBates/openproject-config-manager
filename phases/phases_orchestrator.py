...
if __name__ == '__main__':
    from phase_1_discovery.orchestrator_discovery import DiscoveryPhase
    from phase_2_tui_mapping.orchestrator_tui_mapping import TuiMappingPhase
    from phase_3_collection.orchestrator_collection import CollectionPhase
    from phase_4_validation.orchestrator_validation import ValidationPhase
    from phase_5_export.orchestrator_export import ExportPhase
else:
