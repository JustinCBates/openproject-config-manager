...
def main():
    ...
    repos = {
        "main": {
            "deps_file": Path("/opt/openproject/dependencies/DEPENDENCIES.md"),
            "readme_file": Path("/opt/openproject/README.md")
        },
        "config-manager": {
            "deps_file": Path("/opt/openproject/external/config-manager/dependencies/DEPENDENCIES.md"),
            "readme_file": Path("/opt/openproject/external/config-manager/README.md")
        },
        "deploy-manager": {
            "deps_file": Path("/opt/openproject/external/deploy-manager/dependencies/DEPENDENCIES.md"),
            "readme_file": Path("/opt/openproject/external/deploy-manager/README.md")
        },
        "prober": {
            "deps_file": Path("/opt/openproject/external/prober/dependencies/DEPENDENCIES.md"),
            "readme_file": Path("/opt/openproject/external/prober/README.md")
        },
        "control": {
            "deps_file": Path("/opt/openproject/control/dependencies/DEPENDENCIES.md"),
            "readme_file": Path("/opt/openproject/control/README.md")
        },
        "proxy": {
            "deps_file": Path("/opt/openproject/proxy/dependencies/DEPENDENCIES.md"),
