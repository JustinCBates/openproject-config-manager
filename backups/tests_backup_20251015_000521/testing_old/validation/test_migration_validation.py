...
class MigrationValidator:
    ...
    def test_manager_api(self) -> bool:
        ...
        try:
            ...
            # Test initialization
            required_attributes = [
                'ui', 'env_discovery', 'system_discovery', 'docker_discovery',
                'flow_engine', 'validator', 'exporter'
            ]
    ...
    def test_performance(self) -> bool:
        ...
        try:
            ...
            print(f"   ✅ Performance acceptable (init: {init_time:.3f}s, flows: {flow_load_time:.3f}s, discovery: {discovery_time:.3f}s)")
    ...
    def test_complete_workflow(self) -> bool:
        ...
        try:
            ...
            print(f"   ℹ️  Validation result: {'PASSED' if valid else 'FAILED (expected with test data)'}")
