...
class TestPipelineWithLibraries:
    ...
    def test_validation_phase_can_use_library_units(self, temp_project_root, mock_ui):
        ...
        from phases.libraries import SchemaValidator, DependencyValidator, EnvironmentValidator
    ...
    def test_export_phase_can_use_library_units(self, temp_project_root, mock_ui):
        ...
        from phases.libraries import ExportDockerComposeStep, ExportEnvFileStep, ExportManifestStep
...
class TestPipelineErrorHandling:
    ...
    def test_orchestrator_handles_missing_project_root(self):
        ...
        try:
            ...
            assert "project_root" in str(e).lower() or "path" in str(e).lower() or "directory" in str(e).lower()
